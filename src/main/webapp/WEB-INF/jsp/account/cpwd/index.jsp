        ...
        <form class="form-horizontal tablebox" name="form" role="form" novalidate>
            <div class="form-group">
                ...
                <p class="col-sm-8 padding_l15">
                    <input type="password" class="form-control has-error" ng-model="uum.oldPwd" maxlength="50" maxlength="20" required>
                </p>
            </div>
            ...
            <div class="form-group">
                ...
                <p class="col-sm-8 padding_l15">
                    <input id="confirm" type="password" class="form-control has-error" ng-model="uum.confirm" maxlength="50" maxlength="20" required>
                </p>
            </div>
            <div>
